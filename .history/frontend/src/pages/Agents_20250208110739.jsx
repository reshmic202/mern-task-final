...
function Agents() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100 p-6">
      ...
      {
        showModal && (
          <div className=" fixed top-0 left-0 w-full flex items-center justify-center min-h-screen backd">{
            currentAgentList.length > 0 && (
              <ul className=" space-y-2 w-1/2">
                <span className="text-gray-600 font-bold">Added By: {currentAgentList[0]?.agentId?.name}</span>
                {
